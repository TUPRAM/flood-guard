    ...
    <main className="studio-page" lang={language}>
      ...
      <div className="studio-shell">
        ...
        <section className="studio-section" aria-labelledby="model-title">
          <div className="section-heading"><div><p className="eyebrow">03 · MODELS</p><h2 id="model-title">{th ? "เปรียบเทียบแบบจำลอง" : "Model comparison"}</h2></div><p>{th ? "อย่าเปรียบเทียบเมตริกข้ามขอบเขตหลักฐานโดยตรง" : "Metrics from different evidence scopes are not directly comparable."}</p></div>
