...
| --- | --- | --- | --- | --- |
| **Ayutthaya, 12 October 2024** | Sentinel-1A ascending orbit 172, VV/VH at 11:29:40 UTC. The event and same-orbit 18 September, 6 September, 25 August and 13 August scenes cover AOI-05 by **official catalog geometry**. A genuinely dry pre-scene and finite calibrated grids are not yet verified. [District flooding reported on 9 September](https://ayutthaya.prd.go.th/th/content/category/detail/id/9/iid/322670) makes a recent pre-scene especially unsafe to presume dry. | Sentinel-2B T47PPR at 03:54:24 UTC is about 7 h 35 min before radar. Over all AOI-05 pixel centres, **1,599,131 / 1,718,599 = 93.0485%** pass the frozen buffered SCL mask; **941,218 / 1,718,599 = 54.7666%** also pass all seven reflectance-asset and spectral-denominator validity checks. This passes the frozen 50% *source-feasibility* floor, narrowly; optical water agreement has not been tested. | NASA's 12 October MCDWD_L3 HDF is a potentially independent 250 m optical map with dry/water/insufficient-data codes and permissive LAADS data-use terms. The **actual HDF has not been obtained**: AOI class coverage, input times and georeferencing are therefore unverified. No other complete, rights-cleared flood/dry/unknown layer has been established. | **No selection yet.** Optical source availability passes, but the actual reference, dry radar baseline and processed-grid validity must be checked before selection and a separate complete method/limit freeze. |
