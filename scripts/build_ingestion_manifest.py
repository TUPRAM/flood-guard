"""Build a metadata-only real-data ingestion planning manifest."""
...
def main() -> None:
    """Write the default metadata-only ingestion manifest."""

    output_path = REPO_ROOT / "outputs" / "real_data_ingestion_manifest.csv"
